...
CREATE TABLE `activity_info`  (
  ...
  `activity_name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '活动名称',
  `activity_type` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '活动类型（1：满减，2：折扣）',
  `activity_desc` varchar(2000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '活动描述',
...
CREATE TABLE `activity_rule`  (
  ...
  `activity_type` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '活动类型',
  ...
  `benefit_level` bigint(0) NULL DEFAULT NULL COMMENT '优惠级别',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `operate_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '优惠规则' ROW_FORMAT = Dynamic;
...
CREATE TABLE `activity_sku`  (
  ...
  `operate_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '活动参与商品' ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_attr_info`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `attr_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '属性名称',
  `category_id` bigint(0) NULL DEFAULT NULL COMMENT '分类id',
  `category_level` int(0) NULL DEFAULT NULL COMMENT '分类层级',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `operate_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 115 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '属性表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_attr_value`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `value_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '属性值名称',
  `attr_id` bigint(0) NULL DEFAULT NULL COMMENT '属性id',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 219 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '属性值表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_category1`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `name` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '分类名称',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '一级分类表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_category2`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '二级分类名称',
  `category1_id` bigint(0) NULL DEFAULT NULL COMMENT '一级分类编号',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 114 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '二级分类表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_category3`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '三级分类名称',
  `category2_id` bigint(0) NULL DEFAULT NULL COMMENT '二级分类编号',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1100 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '三级分类表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_dic`  (
  `dic_code` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '编号',
  `dic_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '编码名称',
  `parent_code` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '父编号',
...
-- Records of base_dic
-- ----------------------------
INSERT INTO `base_dic` VALUES ('07', '退款状态', NULL, '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0701', '审批中', '07', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0702', '审核通过', '07', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0703', '审核不通过', '07', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0704', '已发货', '07', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0705', '退款完成', '07', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0706', '退款中', '07', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0707', '退款失败', '07', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('08', '支付状态', '', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0801', '支付中', '08', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0802', '已支付', '08', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0803', '支付失败', '08', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0804', '已关闭', '08', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('09', '订单进度状态', NULL, '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0901', '未支付', '09', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0902', '已支付', '09', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0903', '已通知仓储', '09', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0904', '待发货', '09', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0905', '库存异常', '09', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0906', '已发货', '09', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0907', '已关闭', '09', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0908', '已签收', '09', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0909', '已完结', '09', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0910', '已评价', '09', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0911', '支付失败', '09', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('0912', '订单已拆分', '09', '2021-12-14 00:00:00', NULL);
...
INSERT INTO `base_dic` VALUES ('1003', '待发货', '10', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('1004', '已发货', '10', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('1005', '已关闭', '10', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('1006', '已完成', '10', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('1007', '订单已拆分', '10', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('11', '支付类型', NULL, '2021-12-14 00:00:00', NULL);
...
INSERT INTO `base_dic` VALUES ('1201', '差评', '12', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('1202', '中评', '12', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('1203', '中评', '12', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('1204', '好评', '12', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('1205', '好评', '12', '2021-12-14 00:00:00', NULL);
...
INSERT INTO `base_dic` VALUES ('1404', '已失效', '14', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('15', '退款类型', NULL, '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('1501', '退款', '15', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('1502', '退货', '15', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('16', '支付状态', NULL, NULL, NULL);
INSERT INTO `base_dic` VALUES ('1601', '未支付', '16', NULL, NULL);
INSERT INTO `base_dic` VALUES ('1602', '已支付', '16', NULL, NULL);
INSERT INTO `base_dic` VALUES ('1603', '取消支付', '16', NULL, NULL);
...
INSERT INTO `base_dic` VALUES ('3204', '折扣卷', '32', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('33', '优惠券范围', NULL, '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('3301', '品类券', NULL, '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('3302', '品牌券', NULL, '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('3303', '单品(spu)', NULL, '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('41', '营销类型', NULL, '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('4101', '固定', NULL, '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('4102', '算法', NULL, '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('42', '坑位类型', NULL, '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('4201', 'banner', NULL, '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('4202', '宫格', NULL, '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('4203', '列表', NULL, '2021-12-14 00:00:00', NULL);
INSERT INTO `base_dic` VALUES ('4204', '瀑布', NULL, '2021-12-14 00:00:00', NULL);
...
CREATE TABLE `base_frontend_param`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `code` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '属性名称',
  `delete_id` bigint(0) NULL DEFAULT NULL COMMENT '分类id',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '前端数据保护表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_province`  (
  ...
  `name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '省名称',
  `region_id` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '大区id',
  `area_code` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '行政区位码',
  `iso_code` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '国际编码',
  `iso_3166_2` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'ISO3166编码',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_region`  (
  `id` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '大区id',
  `region_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '大区名称',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_sale_attr`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '销售属性名称',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '基本销售属性表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_trademark`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `tm_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '属性值',
  `logo_url` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '品牌logo的图片路径',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '品牌表' ROW_FORMAT = Dynamic;
...
INSERT INTO `base_trademark` VALUES (3, '华为', '/static/default.jpg', '2021-12-14 00:00:00', NULL);
...
CREATE TABLE `cart_info`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `user_id` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '用户id',
  ...
  `img_url` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片文件',
  `sku_name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'sku名称 (冗余)',
  `is_checked` int(0) NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `operate_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  `is_ordered` bigint(0) NULL DEFAULT NULL COMMENT '是否已经下单',
  `order_time` datetime(0) NULL DEFAULT NULL COMMENT '下单时间',
  `source_type` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '来源类型',
  `source_id` bigint(0) NULL DEFAULT NULL COMMENT '来源编号',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_uid`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 258109 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '购物车表 用户登录系统时更新冗余' ROW_FORMAT = Dynamic;
...
CREATE TABLE `comment_info`  (
  ...
  `head_img` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `sku_id` bigint(0) NULL DEFAULT NULL COMMENT 'skuid',
  `spu_id` bigint(0) NULL DEFAULT NULL COMMENT '商品id',
  `order_id` bigint(0) NULL DEFAULT NULL COMMENT '订单编号',
  `appraise` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '评价 1 好评 2 中评 3 差评',
  `comment_txt` varchar(2000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '评价内容',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `operate_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1608723436069192299 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品评论表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `coupon_info`  (
  ...
  `coupon_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '购物券名称',
  `coupon_type` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '购物券类型 1 现金券 2 折扣券 3 满减券 4 满件打折券',
  `condition_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '满额数（3）',
  `condition_num` bigint(0) NULL DEFAULT NULL COMMENT '满件数（4）',
  `activity_id` bigint(0) NULL DEFAULT NULL COMMENT '活动编号',
  ...
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `range_type` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '范围类型 1、商品(spuid) 2、品类(三级分类id) 3、品牌',
  `limit_num` int(0) NOT NULL DEFAULT 0 COMMENT '最多领用次数',
  `taken_count` int(0) NOT NULL DEFAULT 0 COMMENT '已领用次数',
  ...
  `range_desc` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '范围描述',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '优惠券表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `coupon_range`  (
  ...
  `range_type` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '范围类型 1、商品(spuid) 2、品类(三级分类id) 3、品牌',
  `range_id` bigint(0) NOT NULL DEFAULT 0,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '优惠券范围表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `coupon_use`  (
  ...
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 167656 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '优惠券领用表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `favor_info`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `user_id` bigint(0) NULL DEFAULT NULL COMMENT '用户名称',
  `sku_id` bigint(0) NULL DEFAULT NULL COMMENT 'skuid',
  `spu_id` bigint(0) NULL DEFAULT NULL COMMENT '商品id',
  `is_cancel` varchar(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '是否已取消 0 正常 1 已取消',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `operate_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1608723429735800931 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品收藏表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `financial_sku_cost`  (
  ...
  `sku_id` bigint(0) NULL DEFAULT NULL COMMENT 'sku_id',
  `sku_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品名称',
  `busi_date` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '业务日期',
  `is_lastest` varchar(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '是否最近',
...
CREATE TABLE `order_detail`  (
  ...
  `sku_id` bigint(0) NULL DEFAULT NULL COMMENT 'sku_id',
  `sku_name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'sku名称（冗余)',
  `img_url` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片名称（冗余)',
  ...
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14241058 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '订单明细表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `order_detail_activity`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `order_id` bigint(0) NULL DEFAULT NULL COMMENT '订单id',
  `order_detail_id` bigint(0) NULL DEFAULT NULL COMMENT '订单明细id',
  `activity_id` bigint(0) NULL DEFAULT NULL COMMENT '活动ID',
  `activity_rule_id` bigint(0) NULL DEFAULT NULL COMMENT '活动规则',
  `sku_id` bigint(0) NULL DEFAULT NULL COMMENT 'skuID',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '获取时间',
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7420 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '订单明细购物券表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `order_detail_coupon`  (
  ...
  `order_detail_id` bigint(0) NULL DEFAULT NULL COMMENT '订单明细id',
  `coupon_id` bigint(0) NULL DEFAULT NULL COMMENT '购物券ID',
  `coupon_use_id` bigint(0) NULL DEFAULT NULL COMMENT '购物券领用id',
  `sku_id` bigint(0) NULL DEFAULT NULL COMMENT 'skuID',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '获取时间',
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1608723433946875725 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '订单明细购物券表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `order_info`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `consignee` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收货人',
  `consignee_tel` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收件人电话',
  `total_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '总金额',
  `order_status` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '订单状态',
  `user_id` bigint(0) NULL DEFAULT NULL COMMENT '用户id',
  `payment_way` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '付款方式',
  `delivery_address` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '送货地址',
  `order_comment` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '订单备注',
  `out_trade_no` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '订单交易编号（第三方支付用)',
  `trade_body` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '订单描述(第三方支付用)',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `operate_time` datetime(0) NULL DEFAULT NULL COMMENT '操作时间',
  `expire_time` datetime(0) NULL DEFAULT NULL COMMENT '失效时间',
  `process_status` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '进度状态',
  `tracking_no` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '物流单编号',
  `parent_order_id` bigint(0) NULL DEFAULT NULL COMMENT '父订单编号',
  `img_url` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片路径',
  `province_id` int(0) NULL DEFAULT NULL COMMENT '地区',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_uid_status`(`order_status`, `user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 43020 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '订单表 订单表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `order_refund_info`  (
  ...
  `order_id` bigint(0) NULL DEFAULT NULL COMMENT '订单id',
  `sku_id` bigint(0) NULL DEFAULT NULL COMMENT 'skuid',
  `refund_type` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '退款类型',
  `refund_num` bigint(0) NULL DEFAULT NULL COMMENT '退货件数',
  `refund_amount` decimal(16, 2) NULL DEFAULT NULL COMMENT '退款金额',
  `refund_reason_type` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '原因类型',
  `refund_reason_txt` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '原因内容',
  `refund_status` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '退款状态（0：待审批 1：已退款）',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7110 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '退单表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `order_status_log`  (
  ...
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 106074 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `payment_info`  (
  ...
  `payment_type` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '支付类型（微信 支付宝）',
  ...
  `payment_status` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '支付状态',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `callback_time` datetime(0) NULL DEFAULT NULL COMMENT '回调时间',
  `callback_content` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '回调信息',
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31653 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '支付信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `promotion_pos`  (
  ...
  `pos_location` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '坑位位置',
  `pos_type` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '坑位类型：banner,宫格,列表, 瀑布',
  `promotion_type` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '营销类型：算法、固定、搜索',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `promotion_refer`  (
  `id` bigint(0) NOT NULL,
  `refer_name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '外部营销渠道名称',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `refund_payment`  (
  ...
  `subject` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '交易内容',
  `refund_status` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '退款状态',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `callback_time` datetime(0) NULL DEFAULT NULL COMMENT '回调时间',
  `callback_content` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '回调信息',
  `operate_time` datetime(0) NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 4217 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '退款信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `seckill_goods`  (
  ...
  `sku_id` bigint(0) NULL DEFAULT NULL COMMENT 'sku_id',
  `sku_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '标题',
  `sku_default_img` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品图片',
  ...
  `status` varchar(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '审核状态',
  `start_time` datetime(0) NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` datetime(0) NULL DEFAULT NULL COMMENT '结束时间',
  `num` int(0) NULL DEFAULT NULL COMMENT '秒杀商品数',
  `stock_count` int(0) NULL DEFAULT NULL COMMENT '剩余库存数',
  `sku_desc` varchar(2000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '描述',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sku_attr_value`  (
  ...
  `sku_id` bigint(0) NULL DEFAULT NULL COMMENT 'skuid',
  `attr_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '属性名',
  `value_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '属性值名称',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 130 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = 'sku平台属性值关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sku_image`  (
  ...
  `img_name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片名称（冗余）',
  `img_url` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片路径(冗余)',
  `spu_img_id` bigint(0) NULL DEFAULT NULL COMMENT '商品图片id',
  `is_default` varchar(4000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '是否默认',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 197 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '库存单元图片表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sku_info`  (
  ...
  `sku_name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'sku名称',
  `sku_desc` varchar(2000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品规格描述',
  `weight` decimal(10, 2) NULL DEFAULT NULL COMMENT '重量',
  `tm_id` bigint(0) NULL DEFAULT NULL COMMENT '品牌(冗余)',
  `category3_id` bigint(0) NULL DEFAULT NULL COMMENT '三级分类id（冗余)',
  `sku_default_img` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '默认显示图片(冗余)',
  `is_sale` tinyint(0) NOT NULL DEFAULT 0 COMMENT '是否销售（1：是 0：否）',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '库存单元表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sku_info` VALUES (6, 2, 1299, 'Redmi 10X 4G Helio G85游戏芯 4800万超清四摄 5020mAh大电量 小孔全面屏 128GB大存储 8GB+128GB 冰雾白 游戏智能手机 小米 红米', NULL, 1.00, 1, 61, 'http://47.93.148.192:8080/group1/M00/00/01/rBHu8l-rgJqAHPnoAAF9hoDNfsc505.jpg', 0, '2021-12-14 00:00:00', NULL);
...
INSERT INTO `sku_info` VALUES (16, 4, 10599, '联想（Lenovo） 拯救者Y9000P 2022 16英寸游戏笔记本电脑 i7-12700H RTX3060 冰魄白', '联想（Lenovo） 拯救者Y9000P 2022 16英寸游戏笔记本电脑 i7-12700H RTX3060 冰魄白', 1.00, 3, 61, 'http://47.93.148.192:8080/group1/M00/00/02/rBHu8l-sklaALrngAAHGDqdpFtU741.jpg', 0, '2021-12-14 00:00:00', NULL);
...
CREATE TABLE `sku_sale_attr_value`  (
  ...
  `spu_id` int(0) NULL DEFAULT NULL COMMENT 'spu_id(冗余)',
  `sale_attr_value_id` bigint(0) NULL DEFAULT NULL COMMENT '销售属性值id',
  `sale_attr_id` bigint(0) NULL DEFAULT NULL,
  `sale_attr_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `sale_attr_value_name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 52 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = 'sku销售属性值' ROW_FORMAT = Dynamic;
...
CREATE TABLE `spu_image`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `spu_id` bigint(0) NULL DEFAULT NULL COMMENT '商品id',
  `img_name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片名称',
  `img_url` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片路径',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 97 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品图片表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `spu_info`  (
  ...
  `spu_name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品名称',
  `description` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品描述(后台简述）',
  `category3_id` bigint(0) NULL DEFAULT NULL COMMENT '三级分类id',
...
INSERT INTO `spu_info` VALUES (4, 'HUAWEI P40', 'HUAWEI P40', 61, 3, '2021-12-14 00:00:00', NULL);
...
CREATE TABLE `spu_poster`  (
  ...
  `operate_time` datetime(0) NOT NULL COMMENT '更新时间',
  `is_deleted` tinyint(0) NOT NULL DEFAULT 0 COMMENT '逻辑删除 1（true）已删除， 0（false）未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品海报表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `spu_sale_attr`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号(业务中无关联)',
  `spu_id` bigint(0) NULL DEFAULT NULL COMMENT '商品id',
  `base_sale_attr_id` bigint(0) NULL DEFAULT NULL COMMENT '销售属性id',
  `sale_attr_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '销售属性名称(冗余)',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = 'spu销售属性' ROW_FORMAT = Dynamic;
...
CREATE TABLE `spu_sale_attr_value`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '销售属性值编号',
  `spu_id` bigint(0) NULL DEFAULT NULL COMMENT '商品id',
  `base_sale_attr_id` bigint(0) NULL DEFAULT NULL COMMENT '销售属性id',
  `sale_attr_value_name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '销售属性值名称',
  `sale_attr_name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '销售属性名称(冗余)',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = 'spu销售属性值' ROW_FORMAT = Dynamic;
...
CREATE TABLE `test_province`  (
  ...
  `region_id` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `area_code` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `iso_code` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `iso_3166_2` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `create_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `operate_time` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of test_province
-- ----------------------------
INSERT INTO `test_province` VALUES (3, '山西', '1', '140000', 'CN-14', 'CN-SX', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (4, '内蒙古', '1', '150000', 'CN-15', 'CN-NM', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (5, '河北', '1', '130000', 'CN-13', 'CN-HE', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (6, '上海', '2', '310000', 'CN-31', 'CN-SH', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (7, '江苏', '2', '320000', 'CN-32', 'CN-JS', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (8, '浙江', '2', '330000', 'CN-33', 'CN-ZJ', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (9, '安徽', '2', '340000', 'CN-34', 'CN-AH', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (10, '福建', '2', '350000', 'CN-35', 'CN-FJ', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (11, '江西', '2', '360000', 'CN-36', 'CN-JX', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (12, '山东', '2', '370000', 'CN-37', 'CN-SD', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (13, '重庆', '6', '500000', 'CN-50', 'CN-CQ', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (14, '台湾', '2', '710000', 'CN-71', 'CN-TW', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (15, '黑龙江', '3', '230000', 'CN-23', 'CN-HL', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (16, '吉林', '3', '220000', 'CN-22', 'CN-JL', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (17, '辽宁', '3', '210000', 'CN-21', 'CN-LN', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (18, '陕西', '7', '610000', 'CN-61', 'CN-SN', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (19, '甘肃', '7', '620000', 'CN-62', 'CN-GS', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (20, '青海', '7', '630000', 'CN-63', 'CN-QH', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (21, '宁夏', '7', '640000', 'CN-64', 'CN-NX', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (22, '新疆', '7', '650000', 'CN-65', 'CN-XJ', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (23, '河南', '4', '410000', 'CN-41', 'CN-HA', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (24, '湖北', '4', '420000', 'CN-42', 'CN-HB', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (25, '湖南', '4', '430000', 'CN-43', 'CN-HN', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (26, '广东', '5', '440000', 'CN-44', 'CN-GD', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (27, '广西', '5', '450000', 'CN-45', 'CN-GX', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (28, '海南', '5', '460000', 'CN-46', 'CN-HI', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (29, '香港', '5', '810000', 'CN-91', 'CN-HK', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (30, '澳门', '5', '820000', 'CN-92', 'CN-MO', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (31, '四川', '6', '510000', 'CN-51', 'CN-SC', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (32, '贵州', '6', '520000', 'CN-52', 'CN-GZ', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (33, '云南', '6', '530000', 'CN-53', 'CN-YN', '2021-12-14 00:00:00', NULL);
INSERT INTO `test_province` VALUES (34, '西藏', '6', '540000', 'CN-54', 'CN-XZ', '2021-12-14 00:00:00', NULL);
...
CREATE TABLE `user_address`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `user_id` bigint(0) NULL DEFAULT NULL COMMENT '用户id',
  `province_id` bigint(0) NULL DEFAULT NULL COMMENT '省份id',
  `user_address` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '用户地址',
  `consignee` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收件人',
  `phone_num` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '联系方式',
  `is_default` varchar(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '是否是默认',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `operate_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `user_info`  (
  ...
  `passwd` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '用户密码',
  `name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '用户姓名',
  `phone_num` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '手机号',
  ...
  `user_level` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '用户级别',
  `birthday` date NULL DEFAULT NULL COMMENT '用户生日',
  `gender` varchar(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '性别 M男,F女',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `operate_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  `status` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 237 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `ware_info`  (
  ...
  `areacode` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `ware_order_task`  (
  ...
  `order_id` bigint(0) NULL DEFAULT NULL COMMENT '订单编号',
  `consignee` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收货人',
  `consignee_tel` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收货人电话',
  `delivery_address` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '送货地址',
  `order_comment` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '订单备注',
  `payment_way` varchar(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '付款方式 1:在线付款 2:货到付款',
  `task_status` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '工作单状态',
  `order_body` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '订单描述',
  `tracking_no` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '物流单号',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `ware_id` bigint(0) NULL DEFAULT NULL COMMENT '仓库编号',
  `task_comment` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '工作单备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '库存工作单表 库存工作单表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ware_order_task_detail`  (
  ...
  `refund_status` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '库存工作单明细表 库存工作单明细表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ware_sku`  (
  ...
  `stock_name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '存货名称',
  `stock_locked` int(0) NULL DEFAULT NULL COMMENT '锁定库存数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = 'sku与仓库关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `z_log`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `log` varchar(4000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 42446 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;
