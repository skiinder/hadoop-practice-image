...
create database gmall charset utf8mb4;
create database gmall_report charset utf8mb4;
"
...
hadoop fs -put /opt/module/table-create-sql/data_info.txt /warehouse/gmall/tmp/tmp_dim_date_info/
hive -e "insert into gmall.dim_date select * from tmp_dim_date_info;"
...
hdfs_to_ods_log.sh all 2022-06-08
